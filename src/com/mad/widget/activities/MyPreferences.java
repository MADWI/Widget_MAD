...
import com.mad.widget.connections.WidgetDownload;
...
public class MyPreferences extends PreferenceActivity {
    ...
    /**
     * Pola w ktorych definiowane sa wartosci wyswietlane w poszczegolnych
     * listach
     */
	...
	public boolean onPreferenceClick(Preference groupButton) {
		...
		if ((tabGrupy = wDownload.getGroups(rodzaj, kierunek, stopien,
			...
			Toast.makeText(getApplicationContext(),
				res.getString(R.string.no_groups), 3000).show();
