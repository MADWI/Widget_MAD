...
public class MyPreferences extends PreferenceActivity {
	...
	/*	if (listPreferenceGroup != null) {
		    ArrayList<String> categoryList = wDownload.getGroups(rodzajStudiow, kierunek, stopien, rok); 
		    ...
		    listPreferenceGroup.setEntries(entries);
	...
	private void initPreferences() {
		...
		String rodzaj = preferences.getString("list_of_type", "nieokreslony_rodzaj");
		...
		String kierunek = preferences.getString("list_fos", "nieokreslony_kierunek");
		...
		//grades of studies
		String listDefaultValueGrade = listGradesOfStudy.getEntryValues()[0].toString();
		String listValueGrades = preferences.getString(LIST_GRADE_OF_STUDY, listDefaultValueGrade);
		listGradesOfStudy.setValue(listValueGrades);
		
		String s_stopien = preferences.getString("list_stopien_studiow", "nieokreslony_stopien");
		
		if(s_stopien.equals("5"))
		{
			s_stopien = "1";
		...
		String s_year = preferences.getString("list_year", "nieokreslony_rok");
		...
		tabGrupy = wDownload.getGroups(rodzaj,kierunek,stopien,rok);
		
		for(int kurwa=0;kurwa<tabGrupy.length;kurwa++)
		{
			Log.e(TAG,"<<grupa>>");
			System.out.println("tab" + tabGrupy[kurwa]);
		}
	...
	private void savePreferences()
	{
		...
		editor.putString(LIST_GRADE_OF_STUDY, listGradesOfStudy.getValue());//save grade of study
